...
func DecideAndAct(containers []var_const.ProcProcess) {
	...
	for _, cand := range candidates {
		...
		log.Println("CPU: ", cand.Cpu, " RAM: ", cand.Mem, " RASONAMIENTO CPU: ", isHighCPU && cand.Cpu > var_const.CPU_THRESHOLD, " RASONAMIENTO RAM: ", isHighRAM && cand.Mem > var_const.MEM_THRESHOLD)
